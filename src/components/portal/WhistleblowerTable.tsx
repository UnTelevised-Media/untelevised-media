        ...
        <table className='w-full border-collapse text-sm'>
          <thead>
            <tr className='border-b-2 border-slate-300 bg-slate-100 dark:border-slate-700 dark:bg-slate-900'>
              {['Title', 'Category', 'Severity', 'Priority', 'Status', 'Submitted', ''].map(
                (h) => (
                  <th
                    key={h}
              ...
              return (
                <>
                  ...
                  >
                    ...
                    <td className='px-4 py-4'>
                      <span
                        className={`inline-block px-2 py-0.5 text-xs font-black uppercase tracking-widest ${SEVERITY_COLORS[sub.severity ?? 'medium'] ?? ''}`}
                      >
                        {sub.severity ?? '—'}
                      </span>
                    </td>
                    <td className='px-4 py-4'>
                      <span
                        className={`inline-block px-2 py-0.5 text-xs font-black uppercase tracking-widest ${PRIORITY_COLORS[sub.priority ?? 'medium'] ?? ''}`}
                      >
                        {sub.priority ?? '—'}
                      </span>
                    </td>
