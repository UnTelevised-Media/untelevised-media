  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${
        isScrolled
          ? 'bg-slate-900/98 border-b border-untele/20 shadow-2xl backdrop-blur-md'
          : 'border-b-2 border-untele/30 bg-slate-900/95 shadow-lg backdrop-blur-md'
      }`}
    >
      ...
      <div className='flex w-full items-center justify-between px-4 py-3 lg:px-8'>
        ...
        >
          ...
          <div className='hidden lg:block'>
            <h1 className='bg-gradient-to-r from-white to-slate-200 bg-clip-text text-xl font-bold tracking-tight text-transparent'>
              UnTelevised
            </h1>
        ...
        <nav className='hidden items-center space-x-8 lg:flex'>
          <Link
            href='/'
            className='group relative font-medium text-slate-200 transition-colors duration-200 hover:text-white'
          >
            Home
          ...
          <Link
            href='/live-events'
            className='group flex items-center space-x-2 font-medium text-slate-200 transition-colors duration-200 hover:text-white'
          >
        ...
        <div className='flex items-center space-x-3'>
          {/* Notifications */}
          <button
            className='relative rounded-lg p-2 text-slate-200 transition-all duration-200 hover:bg-slate-800/50 hover:text-untele'
          ...
          <button
            ...
            className='rounded-lg p-2 text-slate-200 transition-all duration-200 hover:bg-slate-800/50 hover:text-untele'
          ...
          <button
            ...
            className='rounded-lg p-2 text-slate-200 transition-all duration-200 hover:bg-slate-800/50 hover:text-untele lg:hidden'
      ...
      {/* Enhanced Search Bar */}
      {isSearchOpen && (
        <div className='border-t border-slate-700 bg-gradient-to-r from-slate-900 to-slate-800 p-6 backdrop-blur-md'>
          <div className='mx-auto max-w-3xl'>
            <div className='relative'>
              ...
              <div className='relative flex items-center'>
                ...
                <input
                  ...
                  className='w-full rounded-lg border border-slate-600 bg-slate-800/90 py-4 pl-12 pr-4 text-slate-100 placeholder-slate-400 backdrop-blur-sm focus:border-untele focus:outline-none focus:ring-2 focus:ring-untele/50'
                  autoFocus
                />
            ...
            <div className='mt-4 flex flex-wrap gap-2'>
              {['Breaking News', 'Live Events', 'Investigations', 'Field Reports'].map((tag) => (
                <button
                  key={tag}
                  className='rounded-full border border-slate-600 bg-slate-800/50 px-3 py-1 text-xs text-slate-300 transition-colors hover:border-untele hover:text-white'
                >
                  {tag}
                </button>
              ))}
      ...
      {isMenuOpen && (
        <div className='border-t border-slate-700 bg-gradient-to-br from-slate-900 to-slate-800 backdrop-blur-md lg:hidden'>
          <nav className='flex flex-col space-y-6 p-6'>
            <Link
              href='/'
              className='flex items-center space-x-3 py-2 font-medium text-slate-200 transition-colors duration-200 hover:text-untele'
