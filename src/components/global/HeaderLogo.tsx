...
function HeaderLogo() {
  return <Link
    href='/'
    className='group flex items-center space-x-2 transition-transform hover:scale-105 md:space-x-3 hlg:hidden 2xl:flex'
  >
    ...
    <div className='hidden 2xl:hidden lxl:block'>
