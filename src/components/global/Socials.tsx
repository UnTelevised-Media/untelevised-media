...
const Socials = () => {
  return (
    <div className='flex items-center gap-1 sm:gap-1.5'>
      ...
      >
        <BsYoutube className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#FF0000] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <BsTwitter className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#1DA1F2] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <BsTwitch className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#9146FF] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <FaTiktok className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#ff0050] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <GrInstagram className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#C13584] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <FaFacebookF className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#1877f2] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <FaRedditAlien className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#FF5700] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <BsDiscord className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#738ADB] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
      <Link
      ...
      >
        <FaTelegram className='h-4 w-4 text-slate-600 transition-colors duration-200 group-hover:text-[#2CA5E0] dark:text-slate-400 sm:h-3 sm:w-3 md:h-3 md:w-3 lg:h-4 lg:w-4 xl:h-5 xl:w-5' />
      </Link>
    </div>
  );
};
