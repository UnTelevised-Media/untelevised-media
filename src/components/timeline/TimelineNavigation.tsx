...
const TimelineNavigation: React.FC<TimelineNavigationProps> = ({
  ...
  return (
    <div
      className={`timeline-navigation rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800 ${className}`}
    >
      <div className='flex flex-wrap items-center justify-between gap-4'>
        ...
        <div className='flex items-center gap-2'>
          <div className='flex items-center rounded-lg border border-slate-200 dark:border-slate-700'>
            ...
            <div className='flex min-w-32 items-center justify-center gap-2 bg-slate-50 px-3 py-2 text-sm font-medium dark:bg-slate-700'>
        ...
        {sortedEvents.length > 0 && (
          <div className='flex items-center gap-2'>
            <div className='flex items-center rounded-lg border border-slate-200 dark:border-slate-700'>
              ...
              <div className='min-w-24 bg-slate-50 px-3 py-2 text-center text-sm dark:bg-slate-700'>
      ...
      {currentEvent && (
        <motion.div
          ...
          className='mt-4 rounded-lg bg-slate-50 p-3 dark:bg-slate-700'
        >
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-2'>
              {currentEvent.isMilestone && (
                <Badge className='bg-yellow-500 text-yellow-900'>Milestone</Badge>
              )}
              <Badge
