...
const TimelineOverview: React.FC<TimelineOverviewProps> = ({
  ...
  return (
    <div className={`timeline-overview space-y-8 ${className}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {categories.map(category => (
              <Link key={category._id} href={`/timeline/category/${category.slug.current}`}>
                <div className="group p-4 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 hover:border-untele/50 transition-all dark:border-slate-700 dark:bg-slate-800 dark:hover:bg-slate-700">
                  <div className="flex items-center gap-3">
                    <div className={`
                    ...
                    <div className="flex-1">
                      <h3 className="font-medium text-sm group-hover:text-untele transition-colors">
                        {category.title}
                      </h3>
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-untele to-red-700 rounded-lg p-8 text-center text-white">
        <h2 className="text-2xl font-bold mb-4">Stay Informed with Timeline Updates</h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link href="/timeline/submit">
            <Button variant="outline" size="lg" className="text-white border-white hover:bg-white hover:text-untele">
