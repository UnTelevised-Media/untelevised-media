...
export default function NotFound() {
  return (
    <div className='flex min-h-screen flex-col items-center justify-center bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900'>
      <h1 className='mb-8 text-9xl font-bold text-untele'>404</h1>
      ...
      <div className='flex gap-6'>
        ...
        <Link
          href='/contact'
          className='rounded-lg border border-slate-700 bg-slate-800/50 px-4 py-2 font-medium text-slate-200 shadow-lg backdrop-blur-sm transition-all duration-200 hover:bg-slate-700/50 hover:text-white'
        >
          Contact Support
        </Link>
      </div>
