      ...
      <section className='border-b border-slate-800 bg-gradient-to-b from-slate-950 to-black py-24'>
        <div className='mx-auto max-w-3xl px-4 text-center'>
          ...
          <p className='mb-4 text-xl leading-relaxed text-slate-300'>
            Thank you for supporting UnTelevised Media. Your membership directly funds independent
            journalism free from corporate influence.
          </p>
          ...
          <p className='mb-2 text-sm text-zinc-400'>
            ...
            {nextBillingDate && (
              <>
                ...
                <span className='font-bold text-white'>{nextBillingDate}</span>.
              </>
            )}
          </p>
