          ...
          <div className='max-w-4xl'>
            ...
            {memberCount > 0 && (
              <p className='text-sm text-zinc-400'>
                Join <span className='font-black text-white'>{memberCount.toLocaleString()}</span>{' '}
          ...
          <div className='grid gap-12 lg:grid-cols-2'>
            <div>
              ...
              <p className='mb-4 leading-relaxed text-slate-300'>
                ...
                news organizations depend on corporate funding, they can&rsquo;t bite the hand that
                feeds them.
              </p>
        ...
        <div className='mx-auto max-w-7xl px-4'>
          <div className='mb-12 text-center'>
            ...
            <p className='mx-auto max-w-3xl text-lg text-slate-300'>
              We practice what we preach. Here&rsquo;s how we maintain transparency in our
              operations.
            </p>
          </div>
