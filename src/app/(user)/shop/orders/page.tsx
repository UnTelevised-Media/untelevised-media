// src/app/(user)/shop/orders/page.tsx
...
export default async function OrdersPage() {
  ...
  if (!userId) redirect('/sign-in?redirect_url=/shop/orders');
    ...
    return (
      <main className='mx-auto max-w-4xl px-4 py-8 sm:px-6'>
        ...
        <div className='border border-slate-200 bg-white px-4 py-12 text-center dark:border-slate-700 dark:bg-slate-900'>
          ...
          <Link href='/shop' className='mt-4 inline-block text-xs text-untele hover:underline'>
