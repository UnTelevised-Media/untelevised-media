// src/app/(user)/shop/order-success/page.tsx
  ...
  try {
    ...
    return (
      <p className='text-sm text-slate-500'>
        ...
        <Link href='/shop/orders' className='text-untele hover:underline'>
          My Orders
        </Link>{' '}
        for confirmation.
      </p>
      ...
      {hasDigital && (
        <div className='mb-4 border border-untele bg-red-50 px-4 py-3 dark:bg-slate-900'>
          <p className='text-xs font-bold text-slate-700 dark:text-slate-300'>
            ...
            <Link href='/shop/downloads' className='font-black text-untele hover:underline'>
              Download Vault
            </Link>
            .
          </p>
