      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                  ...
                  {timeline.timeRange?.startDate && (
                    <div className="flex items-center gap-1">
                      ...
                      <span>
                        ...
                        {timeline.timeRange.endDate && ` - ${formatDate(timeline.timeRange.endDate)}`}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {categories.map(category => (
                      <Link key={category._id} href={`/timeline/category/${category.slug.current}`}>
                        <Badge variant="outline" className="hover:bg-slate-100 dark:hover:bg-slate-800">
                          {category.title}
                        </Badge>
                      </Link>
                    ))}
                ...
                <div className="flex items-center gap-4">
                  <SocialShare 
                    ...
                    description={timeline.shortDescription || ''}
                  />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4 space-y-3">
                <h3 className="font-semibold text-slate-900 dark:text-slate-100">Timeline Stats</h3>
        ...
        <div className="mb-8">
          ...
          <TimelineVisualization
            ...
            initialZoomLevel={timeline.viewSettings?.defaultZoomLevel || 'month'}
            showMilestonesOnly={timeline.viewSettings?.showMilestonesOnly || false}
          />
        </div>
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = timeline.seoSettings?.metaDescription || timeline.shortDescription || timeline.description?.[0]?.children?.[0]?.text || '';
