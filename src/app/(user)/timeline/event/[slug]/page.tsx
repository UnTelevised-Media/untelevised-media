        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              ...
              {/* Social Share */}
              <SocialShare 
                url={`/timeline/event/${event.slug.current}`}
                title={event.title}
                      ...
                      {media._type === 'image' ? (
                        ...
                        <div className="aspect-video rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                          <a 
                            ...
                            className="flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-untele"
                          >
                ...
                <div className="space-y-3">
                  {event.externalLinks.map((link, index) => (
                    <div key={index} className="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
                      ...
                      >
                        <ExternalLink className="h-5 w-5 text-slate-400 group-hover:text-untele mt-0.5" />
                        <div>
                          <h3 className="font-medium text-slate-900 dark:text-slate-100 group-hover:text-untele">
                            {link.title}
                          </h3>
                          {link.description && (
          ...
          <div className="space-y-6">
            ...
            {event.relatedTimelineEvents && event.relatedTimelineEvents.length > 0 && (
              <div className="space-y-3">
                <h3 className="font-semibold text-slate-900 dark:text-slate-100">Related Events</h3>
                <div className="space-y-3">
