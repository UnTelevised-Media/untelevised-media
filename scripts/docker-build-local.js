...
const buildArgs = {
  NEXT_PUBLIC_PRODUCTION_URL:
    process.env.NEXT_PUBLIC_PRODUCTION_URL || 'https://www.untelevised.media',
  NEXT_PUBLIC_DEVELOPMENT_URL: process.env.NEXT_PUBLIC_DEVELOPMENT_URL || 'http://localhost:3000',
  NEXT_PUBLIC_METADATA_BASE_URL:
    process.env.NEXT_PUBLIC_METADATA_BASE_URL || 'https://www.untelevised.media/',
  ...
  NEXT_PUBLIC_SANITY_PROJECT_TITLE:
    process.env.NEXT_PUBLIC_SANITY_PROJECT_TITLE || 'UnTelevised Media',
  ...
  NEXT_PUBLIC_ALGOLIA_SEARCH_API_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_API_KEY || '0509bb2269843dc8bb8887e702c1ff6c',
  NEXT_PUBLIC_CORAL_URL: process.env.NEXT_PUBLIC_CORAL_URL || 'https://coral.untelevised.media',
  NEXT_PUBLIC_SUPABASE_URL:
    process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://tewnvjowrdfzvqcsfwgx.supabase.co',
  NEXT_PUBLIC_SUPABASE_ANON_KEY: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,
  NEXT_PUBLIC_STRIPE_MEMBERSHIP_PUBLISHABLE_KEY:
    process.env.NEXT_PUBLIC_STRIPE_MEMBERSHIP_PUBLISHABLE_KEY,
  ...
  SUPABASE_MEMBERSHIP_URL:
    process.env.SUPABASE_MEMBERSHIP_URL || 'https://tewnvjowrdfzvqcsfwgx.supabase.co',
